...
const app = {
    ...
    // --- FUNGSI TAMBAHAN (Wajib Ada untuk Menu Medicine) ---
    
    // Fungsi Konfirmasi Minum (Munculkan Popup)
    ...
    // Fungsi Eksekusi Simpan (Kurangi Stok & Catat Log)
    saveUseMed(id, index) {
        ...
        // Validasi Stok
        if ((stockItem.init - stockItem.used) <= 0) {
        ...
        this.saveDB();
        this.renderPatientDetail();
        Swal.fire({icon:'success', title:'Obat Diminum', text:'Stok berkurang -1', timer:1000, showConfirmButton:false});
    },
